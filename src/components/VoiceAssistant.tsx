...
const VoiceAssistant: React.FC<VoiceAssistantProps> = ({ onTranscript }) => {
  ...
  // Upgraded to gemini-2.0-flash for the new SDK
  ...
  const startAssistant = async () => {
    ...
    try {
      // ✅ FINAL FIX: Flattened the configuration to stop the LiveConnectConfig warning
  ...
  return (
    <div className="p-4 border rounded-lg shadow-sm bg-white max-w-sm mx-auto">
      <h3 className="text-lg font-bold mb-2">Aqua Quence Voice Assistant</h3>
